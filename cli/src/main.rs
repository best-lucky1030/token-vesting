...
fn main() {
    let matches = App::new(crate_name!())
        ...
        .arg(
            Arg::with_name("program_id")
                ...
                .validator(is_pubkey)
                .takes_value(true)
                .help("Specify the address (public key) of the program."),
        )
        .arg(
        ...
        .arg(
            Arg::with_name("seed")
                ...
                .takes_value(true)
                .help("Specify the seed for the vesting contract."),
        )
        .subcommand(
            SubCommand::with_name("create")
                .about("Create a new vesting contract with an optionnal release schedule")
                .arg(
        ...
        .subcommand(
            SubCommand::with_name("unlock")
                .about(
                    "Unlock a vesting contract. This will only release \
        ...
        .subcommand(
            SubCommand::with_name("change-destination")
                .about("Change the destination of a vesting contract")
                .arg(
        ...
        .subcommand(
            SubCommand::with_name("info").about("Print information about a vesting contract"),
        )
        .get_matches();
    ...
    let vesting_seed = (*String::as_bytes(&value_of(&matches, "seed").unwrap()))
        .try_into()
        .unwrap();
    ...
    let _ = match matches.subcommand() {
        ...
        ("change-destination", Some(arg_matches)) => {
            ...
            let new_destination_token_account =
                match pubkey_of(arg_matches, "new_destination_token_address") {
                    None => get_associated_token_address(
                        &pubkey_of(arg_matches, "new_destination_address").unwrap(),
                        &mint_address,
                    ),
