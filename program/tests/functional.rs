...
async fn test_token_vesting() {
    ...
    let vesting_token_account_key =
        get_associated_token_address(&vesting_account_key, &mint_address);
    program_test.add_account(
    ...
    let source_token_account_key =
        get_associated_token_address(&source_token_account_owner_keypair.pubkey(), &mint_address);
    program_test.add_account(
    ...
    transaction.sign(
        &[&payer, &source_token_account_owner_keypair],
        recent_blockhash,
    );
